...
public class GradientBorderTextView2 extends android.support.v7.widget.AppCompatTextView {
    ...
    public GradientBorderTextView2(Context context) {
        this(context, null);
    }

    public GradientBorderTextView2(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GradientBorderTextView2(Context context, AttributeSet attrs, int defStyleAttr) {
