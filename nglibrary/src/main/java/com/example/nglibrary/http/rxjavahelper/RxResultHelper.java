package com.example.nglibrary.http.rxjavahelper;
...
public class RxResultHelper {
    ...
    public static <T> ObservableTransformer<ResponseData<T>, T> handleResult2() {
...
//    }
    ...
    //    public static <T> ObservableTransformer<ResponseData<T>, T> handleResult() {
//        return (Observable<ResponseData<T>> upstream) -> {
